...
import { Text,Image,View,SafeAreaView,TouchableOpacity,ScrollView,TextInput } from "react-native";
     ...
     return(
        <SafeAreaView style={{flex:1}}>
           ...
           <View style={{alignItems:'center',marginBottom:40}}>
                <Image style={{height:200,width:376}} source={{uri:'https://photo-cms-kienthuc.zadn.vn/zoom/800/uploaded/ctvquansu/2021_01_10/vn/khau-sung-thay-the-cho-tieu-lien-ak-huyen-thoai-cua-viet-nam-hinh-4.jpg'}} />
                </View>
                <View style={{flexDirection:'row',position:"absolute",top:160,left:140}}>
                <Image style={{ width: 80, height: 80, borderRadius: 40, margin: 10 }} source={require("../accset/img/39013954-f5091c3a-43e6-11e8-9cac-37cf8e8c8e4e.jpeg")}/>
                </View>
           </View>
            ...
            <View style={{alignItems:'center',flexDirection:'row',paddingLeft:100}}>
                <TouchableOpacity style={{fontSize: 20,}}><Text>Tất cả bài viết</Text></TouchableOpacity>
                <TouchableOpacity style={{padding:12,paddingLeft:40}}><SimpleLineIcons name="user-unfollow" size={18} color="black" /></TouchableOpacity>
            </View>
